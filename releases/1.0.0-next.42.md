...
More features
- State and block overrides added to eth_call and tevm_call https://github.com/evmts/tevm/pull/976
- tevm_getAccount can now optionally return contract storage for the account https://github.com/evmts/tevm/pull/976
- lots of json_rpc endpoints added but will not be stable til a later release
- new traceConfig property in tevm_call, tevm_script, and tevm_contract will return an EVM trace https://github.com/evmts/tevm/pull/1036
...
- Fixed bug with not returning the correct createdAddresses in tevm_call https://github.com/evmts/tevm/pull/1020
