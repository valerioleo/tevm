...
The command schema in [`cli/src/commands/action/createAccessList.tsx`](https://github.com/evmts/tevm/blob/main/cli/src/commands/action/createAccessList.tsx) exposes:
