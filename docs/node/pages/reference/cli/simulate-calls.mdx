...
The command schema in [`cli/src/commands/action/simulateCalls.tsx`](https://github.com/evmts/tevm/blob/main/cli/src/commands/action/simulateCalls.tsx) exposes:
