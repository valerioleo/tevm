...
The command schema in [`cli/src/commands/createContractEventFilter.tsx`](https://github.com/evmts/tevm-monorepo/blob/main/cli/src/commands/createContractEventFilter.tsx) exposes:
