...
The command schema in [`cli/src/commands/action/sendRawTransaction.tsx`](https://github.com/evmts/tevm-monorepo/blob/main/cli/src/commands/action/sendRawTransaction.tsx) exposes:
