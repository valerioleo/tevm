...
[@tevm/actions](../globals.md) / buildRpcMethodMatrix

# Function: buildRpcMethodMatrix()
...
| ------ | ------ | ------ |
| `runtimeMethods` | readonly `string`[] | `undefined` |
| `typedMethods` | readonly `string`[] | `[]` |

## Returns

readonly [`RpcMethodMatrixEntry`](../type-aliases/RpcMethodMatrixEntry.md)[]
