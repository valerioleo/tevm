...
Defined in: [packages/actions/src/GetAccount/GetAccountJsonRpcRequest.ts:8](https://github.com/evmts/tevm/blob/main/packages/actions/src/GetAccount/GetAccountJsonRpcRequest.ts#L8)
