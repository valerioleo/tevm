...
[@tevm/actions](../globals.md) / EthChainIdJsonRpcProcedure
...
Defined in: [packages/actions/src/eth/EthProcedure.ts:115](https://github.com/evmts/tevm/blob/main/packages/actions/src/eth/EthProcedure.ts#L115)
