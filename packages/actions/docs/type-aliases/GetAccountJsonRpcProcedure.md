...
Defined in: [packages/actions/src/GetAccount/GetAccountJsonRpcProcedure.ts:7](https://github.com/evmts/tevm/blob/main/packages/actions/src/GetAccount/GetAccountJsonRpcProcedure.ts#L7)
