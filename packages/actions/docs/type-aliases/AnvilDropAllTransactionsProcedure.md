...
[@tevm/actions](../globals.md) / AnvilDropAllTransactionsProcedure

# Type Alias: AnvilDropAllTransactionsProcedure
...
`Promise`\<[`AnvilDropAllTransactionsJsonRpcResponse`](AnvilDropAllTransactionsJsonRpcResponse.md)\>
