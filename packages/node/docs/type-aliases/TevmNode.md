...
> `readonly` **getSnapshot**: (`snapshotId`) => [`TevmSnapshot`](TevmSnapshot.md) \| `undefined`
...
[`TevmSnapshot`](TevmSnapshot.md) \| `undefined`

### getSnapshots

> `readonly` **getSnapshots**: () => `Map`\<`string`, [`TevmSnapshot`](TevmSnapshot.md)\>
