...
Defined in: [tevm-monorepo/packages/receipt-manager/src/ReceiptManager.ts:94](https://github.com/evmts/tevm/blob/main/packages/receipt-manager/src/ReceiptManager.ts#L94)
